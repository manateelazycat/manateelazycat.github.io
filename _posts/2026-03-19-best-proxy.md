...
2. 点击 ‘工具’ 标签， 选择基本配置，打开 IPv6 开关， 保证懒猫微服可以正常通讯 （懒猫微服的域名规则已经在上面配置好了）
3. 点击 ‘代理’ 标签， 选择自建/家宽节点， 选择一个你喜欢的服务器
4. 点击 ‘仪表盘’ 标签， 打开虚拟网卡开关（模式用 mixed）， 出站模式用 ‘规则’ 
5. 点击 ‘工具’ 标签， 应用程序里面打开 ‘自启动’、‘静默启动‘、 ’自动运行‘ 的选项

最后点击仪表盘右下角开始按钮就可以正常上网了

### 手机端
FLCash 也有手机客户端，相同配置方法即可
