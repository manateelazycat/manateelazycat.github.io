---
layout: post
title: 代理配置 2026-06-26 Xray VPS 一键部署
categories: [Proxy]
---
...
添加好了域名解析等 1 ~ 2 分钟， 一般你 ping hy2.你的域名 可以 ping 通就证明域名解析生效了
...
第一个 VPS 绑定的域名不变，依然是 hy2.你的域名，第二个问题伪装目标的域名换一个，比如 www.bing.com、www.apple.com 这种正常可以访问的网站域名。
