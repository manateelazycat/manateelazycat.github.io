...
* 普通用户对开源的理解：很多普通用户对开源可以说完全没有概念的，他们从来没有接触过开源，他们不知道开源背后的发展历史和理念，他们也很难像开源开发者那样对开源从感动到信仰。这也是我非常反对很多国内开源开发者和很多开源布道者对普通用户灌输开源理念，就像宝马工程师向普通人讲解引擎的工作原理和技术细节一样，每个普通用户都有自己的生活，他们不会花费时间听开源开发者bla bla bla。甚至很多长辈听到开源就是把自己写的代码无偿的分享给全世界以后都会说：“你傻啊？”。　
...
* 政府对开源的理解：政府方面在开源的认识我觉得是最浅显的，政府不论从国家博弈还是国家安全的角度考虑完全自主可控都是无可厚非的。从另外一方面微软对于美国是自主可控的，但是反观国内的操作系统厂商和国产应用生态现状，依然在大量在用开源社区的代码。对于开源代码从内核、软件仓库到桌面环境和上层应用，即使国内源码掌握程度最高的深度操作系统都不能说对所有的开源代码进行掌握，甚至还有很多地方直接用的是上游开源项目构建而成的。所以自主可控在我看来，本质上是对代码的使用和掌握的熟练程度，而不仅仅是现在政府单位认为的只要拷贝上游开源社区的代码，甚至连内容都没改就像很多国内厂商说的自己是完全自主可控的。　如果对于开源代码的理解程度不够，仅仅只是拷贝后“占有”代码，这不叫自主可控，说大一点这叫偷窃开源社区成果，说小一点这叫“鸵鸟”，明明没有掌握开源代码，然后自欺欺人的告诉自己完全自主可控了。自主可控的目标一定是先学习开源社区的技术，融会贯通，才能编写真正有影响力的代码影响开源社区（就像 RedHat, IBM, Samsung 这些开源大户做的一样）。
