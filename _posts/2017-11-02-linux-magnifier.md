...
![]({{site.url}}/pics/linux-magnifier/linux-magnifier-1_update.gif)

所以一直一来都想做一个交互极简的取色器，最好鼠标移动到目标位置，快捷键直接启动取色器，点击就马上取色并自动复制到系统剪切板。
经过三天的研究终于做出了我理想中的取色器，世界上最简单的屏幕取色器：

![深度录屏_Desktop_20171102165716.gif]({{site.url}}/pics/linux-magnifier/linux-magnifier-2_update.gif)
...
![深度截图_选择区域_20171102175731.png]({{site.url}}/pics/linux-magnifier/linux-magnifier-3_update.png)

像深度截图这种传统的图层绘制方式有一个巨大的缺点，就是每次光标移动的时候，都会触发 “屏幕截图图层” 重新绘制，即使光标下的区域只更新了非常小的区域，这样就会造成潜在的性能问题。

![3 (1).png]({{site.url}}/pics/linux-magnifier/linux-magnifier-4_update.png)
...
![2.png]({{site.url}}/pics/linux-magnifier/linux-magnifier-5_update.png)
