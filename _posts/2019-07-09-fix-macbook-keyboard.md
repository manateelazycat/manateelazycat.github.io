...
![MacBook Pro-Keyboard]({{site.url}}/pics/macbook-keyboard/1_update.jpeg)
...
![MacBook Pro-Keyboard]({{site.url}}/pics/macbook-keyboard/2_update.png)
...
![MacBook Pro-Keyboard]({{site.url}}/pics/macbook-keyboard/3_update.png)

### 修复
首先在淘宝上花 10 块买一个 MacBook 的底座和支架， 老板可以剪给你, 如下图一所示：

![MacBook Pro-Keyboard]({{site.url}}/pics/macbook-keyboard/4_update.png)

然后用镊子把底座从电路板上撕下来， 注意底座和支架最后需要再粘贴到笔记本上， 所以撕的时候一定要小心和耐心， 一点点的撕， 不要把底座和支架撕坏了。 最终会变成上图中图二和图三的单个零件。

附一张我撕底座的残骸， 看着好暴力的赶脚.

![MacBook Pro-Keyboard]({{site.url}}/pics/macbook-keyboard/5_update.png)
